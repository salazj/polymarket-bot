    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm">Platform overview and quick controls</p>
        </div>
      ...
      {/* Error banner */}
      {botStatus.error && (
        <div className="rounded-lg border border-red-700/50 bg-red-950/40 p-4 text-sm text-red-300">
      ...
      <div className="grid gap-4 grid-cols-2 lg:grid-cols-4">
        <Card className="relative overflow-hidden">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Activity className={`h-4 w-4 ${botStatus.running ? "text-emerald-400" : "text-muted-foreground"}`} />
          </CardHeader>
          <CardContent>
          ...
          {botStatus.running && (
            <div className="absolute top-0 right-0 h-1 w-full bg-gradient-to-r from-emerald-500/0 via-emerald-500/60 to-emerald-500/0" />
          )}
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold tabular-nums">{formatUSD(portfolio.total_exposure)}</div>
            <p className="text-xs text-muted-foreground mt-1">
              {portfolio.position_count} position{portfolio.position_count !== 1 ? "s" : ""} · Cash: {formatUSD(portfolio.cash)}
            </p>
          </CardContent>
        </Card>
